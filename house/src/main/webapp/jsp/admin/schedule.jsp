...
<div>
	<form id="staticForm" name="staticForm"
		action="/static/schedule/selectAll.action"
		method=post >
						 <div class="result-title">
							...
							<tbody>
								...
								<c:forEach items="${pageInfo.list}" var="schedule">
									<tr
										...
										<td>
										<a class="link-update"
											href="/toupdate?id=${schedule.id}">修改</a>
											&nbsp;&nbsp; 
											<input type="hidden" name="id" value="${staticlist.id}"/>
											<a class="link-del"
											 href="/deleteschedule?id=${schedule.id}"
