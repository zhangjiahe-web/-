...
<div class="sidebar-title">
        <form action="/checkuserlist1" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            <c:if test="${empty userlist.phone }">
                                <th><i class="require-red">*</i>手机号码：</th>
                                <td><input class="common-text" name="phone" value="${userlist.phone }" id="phone" size="50" type="text" ></td>
                            </c:if>
                            <c:if test="${not empty userlist.phone }">
                                <th><i class="require-red">*</i>手机号码：</th>
                                <td><input class="common-text" name="phone" value="${userlist.phone }" id="phone" size="50" readonly="readonly" type="text" ></td>
                            </c:if>
