				...
				<ul class="sidebar-list">
					<li><a class="a" id="fangyuan">房源信息</a>
						<div class="p" id="afangyuan">
							<ul class="sub-menu">
								<li><a href="/ahouselist" class="ziliao">房源列表</a></li>
								<li><a href="/toaddhouse" class="ziliao">添加房源</a></li>
							</ul>
						</div></li>
					<li><a class="a" id="zulin">租赁及合同信息</a>
						<div class="p" id="azulin">
							<ul class="sub-menu">
								<li><a href="/toZuList" class="ziliao">在租列表</a></li>
								<li><a href="/toCheckout" class="ziliao">已退租列表</a></li>
							</ul>
						</div></li>
					<li><a class="a" id="sq">申请列表</a>
						<div class="p" id="asq">
							<ul class="sub-menu">
								<li><a href="/findapplylist" class="ziliao">看房申请</a></li>
								<li><a href="/goapplyout" class="ziliao">退租申请</a></li>
					...
					<li><a class="a" id="baoz">报障模块</a>
						<div class="p" id="abaoz">
							<ul class="sub-menu">
								<li><a href="/towronglist" class="ziliao">待处理报障</a></li>
								<li><a href="/toSolve" class="ziliao">已处理报障</a></li>
					...
					<li><a class="a" id="xinxi">租金信息</a>
						<div class="p" id="axinxi">
							<ul class="sub-menu">
								<li><a href="/toshowaddpaid" class="ziliao">我要收租</a></li>
								<li><a href="/topaidlist" class="ziliao">租客待缴租金</a></li>
								<li><a href="/selectall" class="ziliao">租客已缴租金</a></li>
					...
					<li><a class="a" id="ric">我的日程</a>
						<div class="p" id="aric">
							<ul class="sub-menu">
								<li><a href="/selectAll" class="ziliao">查看日程</a></li>
								<li><a href="/toinsert" class="ziliao">添加日程</a></li>
					...
					<li><a class="a" id="qita">其他操作</a>
						<div class="p" id="aqita">
							<ul class="sub-menu">
								<li><a href="/findalluserlist" class="ziliao">账户管理</a></li>
							</ul>
							<ul class="sub-menu">
								<li><a href="/findhasuserlist1">账户绑定</a></li>
							</ul>
						</div></li>
				</ul>
			</div>
...
<script type="text/javascript">
    $(".ziliao").click(function(){
        $.ajax({url:"/checkuserlists1",success:function(date){
                if(date.status=='true'){
                    return true;
                }else{
                    alert("请先完善资料再访问本资源");
                    window.location="/findhasuserlist1";
                    return false;
                }
