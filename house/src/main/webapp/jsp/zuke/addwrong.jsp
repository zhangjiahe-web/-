...
<div class="sidebar-title">
        <form action="/insertwrong" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                        	<tr>
                                <th><i class="require-red">*</i>房屋id：</th>
                                <td>
                                    <input class="common-text required" value="${paid.houseId}" id="house_id" name="houseId" size="50" type="text" >
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>地址：</th>
                                <td><input class="common-text" name="address" value="${paid.address }" id="address" size="50" type="text" ></td>
                            </tr>
                             <tr>
